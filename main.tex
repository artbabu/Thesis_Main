...
\begin{figure}[!tbp]
	...
	\begin{minipage}[b]{0.57\textwidth}
		...
		\label{doc-word}
		\tcbox{\includegraphics[scale=0.30]{image/doc-word.png}}
	\end{minipage}
	\begin{minipage}[b]{0.57\textwidth}
		\centering
		\caption{Term-Context Matrix}
		\label{word-word}
		\tcbox{\includegraphics[scale=0.30]{image/word-word.png}}    
	\end{minipage}
\end{figure}
...
\label{results}
 ...
 \begin{table}[h]
 	...
 	\begin{tabular}{|l|c|c|}
 		...
 		SVM                                       & \begin{tabular}[c]{@{}c@{}}Support Vector Classifier \\ ( Kernel: Polynomial)\end{tabular}        & \begin{tabular}[c]{@{}c@{}}Support Vector Regressor\\ (Kernel : Polynomial)\end{tabular}           \\ \hline
 		Random Forest                             & RFClassifier ( estimators = 200)                                                            & RFRegressor ( estimators = 200)                                                              \\ \hline
 		Gradient Boosting                         & GBClassifier ( estimators = 200)                                                            & GBRegressor ( estimators = 200)                                                              \\ \hline
 		Ensemble              performed                    & Voting based classifier                                                                     & \begin{tabular}[c]{@{}c@{}}Stacking Model\\  ( meta-model  : Linear Regression)\end{tabular} \\ \hline
 	\end{tabular}
 \end{table}
...
\begin{table}[htb]
	...
	\begin{tabular}{|l|l|l|l|}
		\hline
		\multicolumn{2}{|c|}{\textbf{Algorithms}}                            & \textbf{RTE (Test)} & \multicolumn{1}{c|}{\textbf{\begin{tabular}[c]{@{}c@{}}Sentence Relatedness\\  (Test)\end{tabular}}} \\ \hline
